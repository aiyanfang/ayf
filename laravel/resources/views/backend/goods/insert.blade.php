        ...
        <form action="insert" method="post">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="goods_desc" id="" cols="50" rows="5"></textarea>
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="">
                        ...
                        @foreach($typeData as $key => $item)
                            <option value="">{{$item['type_name']}}</option>
                        @endforeach  
                    </select>
                ...
                <div class="form-group">
                    <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">出售价格</font></font></label>
                    <input type="text" class="form-control" name="sell_price" id="sell_price">
                    <span id="mobile_info"></span>
                </div>
                <div class="form-group">
