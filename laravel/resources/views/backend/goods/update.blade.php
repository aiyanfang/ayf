                ...
                <div class="form-group">
                  ...
                  <div class="radio" style="margin-left:20px;">
                    @if($updateData['is_super'] == 0)
                        <label><input type="radio" name="is_fweze" value="0" <?php if($updateData['is_freeze'] == 1){ echo "checked=''";}?>>可用</label>
                        <label><input type="radio" name="is_fweze"  value="1" <?php if($updateData['is_freeze'] == 0){ echo "checked=''";}?>>冻结</label>
                    @endif
                  </div>
                </div>
                <div class="form-group">
                  <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">分配角色</font></font></label>
                    <div class="checkbox" style="margin-left:20px;">
                        @foreach($roles as $key => $item)
                            <label>
                                <input type="checkbox" class="from-control" name="role[]" id="role" value="{{$item['role_id']}}" <?php if($item['role_id'] == $roleData['role_id']){ echo "checked=''";}?>>
                                {{$item['role_name']}}
                            </label>
                        @endforeach
                            <span id="r_info"></span>
