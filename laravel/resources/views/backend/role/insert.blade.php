                    ...
                    <div class="checkbox" style="margin-left:20px;">
                        @foreach($menuData as $key => $value)
                            <div style="margin-left:3rem;">
                                <input type="checkbox" class="from-control" name="menus[]" value="{{$value['menu_id']}}" id="cb_all">
                                {{$value['menu_name']}}
                            </div>
                            <div style="margin:1rem 0 1rem 0;margin-left:4rem;">
                                @foreach($value['son'] as $key => $item)
                                <label style="">
                                    <input type="checkbox" class="from-control" name="menus[]" value="{{$item['menu_id']}}" id="cb_fruit">
                                    {{$item['menu_name']}}
                                </label>
                                @endforeach
                            </div>
